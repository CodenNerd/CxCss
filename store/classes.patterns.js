...
const classPatterns = {
  ...
  [`^radius-${digitPattern}$`]: '@layer base {.radius-$1 { border-radius: $1px; } }',
  [`^radius-${digitPattern}p$`]: '@layer base {.radius-$1p { border-radius: $1%; } }',
  [`^radius-t-r-${digitPattern}$`]: '.radius-t-r-$1 { border-top-right-radius: $1px;  }',
  [`^radius-t-l-${digitPattern}$`]: '.radius-t-l-$1 { border-top-left-radius: $1px;  }',
  [`^radius-b-r-${digitPattern}$`]: '.radius-b-r-$1 { border-bottom-right-radius: $1px;  }',
  [`^radius-b-l-${digitPattern}$`]: '.radius-b-l-$1 { border-bottom-left-radius: $1px;  }',
